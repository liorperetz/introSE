...
public class ReflectionRefractionTests {
    ...
    public void testBeam() {
        ...
        scene._geometries.add(//
                ...
                new Polygon(new Point3D(29.116241964534673, -238.232615468666893, -39.25099404785152),
                        ...
                        new Point3D(-146.264361040333483, 66.510353720166705, -48.605653457185355)).
                        setEmission(new Color(20, 20, 20)).
                        setMaterial(new Material().setKr(0.8).setKGlossy(10)),
                new Sphere(20, new Point3D(20.116807047047587, -13.862502322740898, 0)).
                        setEmission(new Color(82, 181, 188)).setMaterial(new Material().setKd(0.25).setKs(0.3).setShininess(20)),
                new Sphere(15, new Point3D(-10.132589295428716, 32.379903137629952, 7)).
                        setEmission(new Color(java.awt.Color.pink)).setMaterial(new Material().setKd(0.25).setKs(0.3).setShininess(20)),
    ...
    public void testBeam1() {
        ...
        scene._geometries.add(//
                new Polygon(new Point3D(50, -13.5, 0),
                        new Point3D(50, 14, 0),
                        new Point3D(50, -13.5, 7))
                        .setEmission(new Color(0, 40, 100)) //
                        .setMaterial(new Material().setKd(0.25).setKs(0.25).setShininess(20).setKt(1).setKBlur(10)),

                new Sphere(20, new Point3D(20.116807047047587, -13.862502322740898, 0)).
                        setEmission(new Color(java.awt.Color.gray)).setMaterial(new Material().setKd(0).setKs(0.3).setShininess(20)));
        ...
        ImageWriter imageWriter = new ImageWriter("refraction", 1000, 1000);
        Render render = new Render() //
                .setImageWriter(imageWriter) //
                .setCamera(camera) //
                .setRayTracer(new BasicRayTracer(scene));
    ...
    public void lite() {
        ...
        scene._geometries.add(//
                new Plane(new Point3D(0, 1, 0),
                        ...
                        new Point3D(-1, 0, 15)).
                        setEmission(new Color(30, 30, 30)).
                        setMaterial(new Material().setKr(1).setKGlossy(10)),
    ...
    public void litelite() {
        ...
        scene._geometries.add(//
                new Polygon(new Point3D(0, -4, 0),
                        ...
                        new Point3D(-4, 0, 0)).
                        setEmission(new Color(30, 30, 30)).
                        setMaterial(new Material().setKr(1).setKGlossy(10).setKs(0.4).setShininess(30)),
    ...
    public void targil8() {
        ...
        Scene scene = new Scene("Test scene").setAmbientLight(new AmbientLight(new Color(java.awt.Color.WHITE), 0.15));
        Camera camera = new Camera(new Point3D(100, 20, 50), new Vector(-5, 1, 0), new Vector(0, 0, 1)) //
        ...
        scene._geometries.add(new Polygon(Q,O,K).setEmission(new Color(java.awt.Color.ORANGE)).setMaterial(new Material().setKd(0.25).setKs(0.3).setShininess(20)),
        ...
        //Right cube
        Point3D A=new Point3D(-119.126345343447156, 55.188148144158816, 0);
        Point3D B=new Point3D(-218.281167997278999, 109.00446363953202, 0);
        Point3D C=new Point3D(-272.097483492652202, 9.849640985700162, 0);
        Point3D D=new Point3D(-172.942660838820359, -43.966674509673027, 0);
        Point3D E=new Point3D(-119.126345343447156, 55.188148144158816, 112.817882753623735);
        Point3D F=new Point3D(-218.281167997278999,109.00446363953202,112.817882753623735);
        Point3D G=new Point3D(-272.097483492652202, 9.849640985700177, 112.817882753623735);
        Point3D H=new Point3D(-172.942660838820359, -43.966674509673027, 112.817882753623735);
        ...
        //Right pyramid
        Point3D top=new Point3D(-195.611914418049679, 32.518894564929489, 0).
                add(B.subtract(F).normalize().scale(60));

        scene._geometries.add(new Polygon(top,A,B).setEmission(new Color(java.awt.Color.ORANGE)).setMaterial(new Material().setKd(0.25).setKs(0.3).setShininess(20)),
                new Polygon(top,B,C).setEmission(new Color(java.awt.Color.PINK)).setMaterial(new Material().setKd(0.25).setKs(0.3).setShininess(20)),
                new Polygon(top,C,D).setEmission(new Color(java.awt.Color.pink)).setMaterial(new Material().setKd(0.25).setKs(0.3).setShininess(20)),
                new Polygon(top,A,D).setEmission(new Color(java.awt.Color.PINK)).setMaterial(new Material().setKd(0.25).setKs(0.3).setShininess(20)));

        //hand
        Point3D midPointEG=new Point3D(-195.611914418049679, 32.518894564929496, 112.817882753623735);
        ...
        scene._geometries.add(new Plane(new Point3D(15.41493101796042, -12.530455279045601, -20.331714129217218),
                new Point3D(45.361300076875764, 66.590279814672073, -6.442114332450545),
                new Point3D(-15.338639484045661, 33.790653850907191, -8.054955173649793)).
                setEmission(new Color(30, 30, 30)).
                setMaterial(new Material().setKd(0.4).setKs(0.8).setShininess(60).setKt(0.3)));
        ...
        ImageWriter imageWriter = new ImageWriter("imageToTargil8", 1000, 1000);
        Render render = new Render() //
                .setImageWriter(imageWriter) //
                .setCamera(camera) //
                .setRayTracer(new BasicRayTracer(scene));
